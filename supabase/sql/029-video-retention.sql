-- Mirror: supabase/migrations/029_video_retention.sql
...
-- Enable deletion after verifying dry-run list:
-- update public.app_config
-- set value = jsonb_set(value, '{expiry_enabled}', 'true'::jsonb, true)
-- where key = 'video_retention';
