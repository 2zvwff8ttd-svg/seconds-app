-- Supabase SQL Editor: run this once for push notification device tokens (Phase 1).
-- Same as supabase/migrations/025_push_device_tokens.sql
--
-- Stores APNs/FCM tokens per user device. Edge Functions (service_role) read enabled
-- tokens to send pushes; clients upsert their own token after login.
