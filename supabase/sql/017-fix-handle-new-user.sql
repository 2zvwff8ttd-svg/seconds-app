-- 新規登録時の profiles 作成失敗を修正（SQL Editor 用）
-- Dashboard → SQL Editor → 全文コピー → Run
-- 原因: username が CHECK 制約違反だと handle_new_user が失敗し
--       Auth が "Database error saving new user" を返す
